        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="index.php" class="logo"><span>پنل <span>شما</span></span><i class="zmdi zmdi-layers"></i></a>
                </div>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div class="user-box">
                        <div class="user-img">
                            <img src="assets/images/profile.jpg" alt="user-img" title="Mat Helme" class="img-circle img-thumbnail img-responsive">
                            <div class="user-status offline"><i class="zmdi zmdi-dot-circle"></i></div>
                        </div>
                        <h5><a href="#"><?php echo $getData['username']; ?></a> </h5>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="index.php" class="waves-effect "><i class="zmdi zmdi-view-dashboard"></i> <span> داشبورد </span> </a>
                            </li>

                            <li>
                                <a href="menu.php" class="waves-effect "><i class="fa fa-reorder"></i> <span> صفحه منو ها </span> </a>
                            </li>

                            <li>
                                <a href="menu-tab.php" class="waves-effect "><i class="fa fa-reorder"></i> <span> مدیریت منو ها </span> </a>
                            </li>

                            <li>
                                <a href="posts.php" class="waves-effect "><i class="fa fa-tags"></i> <span> افزودن پست </span> </a>
                            </li>

                            <li>
                                <a href="users.php" class="waves-effect "><i class="fa fa-user"></i> <span> کاربران </span> </a>
                            </li>
